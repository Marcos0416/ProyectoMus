        ...
        LazyColumn(
            ...
            item {
                ...
                Row(
                    ...
                    Text("$currentUsername y Pepe: ${musGameViewModel.pareja1Puntos.collectAsState().value}")
                    Text("Angel y Alberto: ${musGameViewModel.pareja2Puntos.collectAsState().value}")
                }
            }
                ...
                if (!rondaActiva && cartasRepartidas) {
                    Column {
                        ...
                        if (ganadorPares != null) {
                            val parejaGanadora = obtenerNombreParejaGanadora(ganadorPares!!.first, jugadores)
                            Text(
                        ...
                        if (ganadorJuego != null) {
                            val parejaGanadora = obtenerNombreParejaGanadora(ganadorJuego!!.first, jugadores)
    ...
    fun obtenerNombreParejaGanadora(ganador: Jugador, jugadores: List<Jugador>): String {
        val index = jugadores.indexOfFirst { it.nombre == ganador.nombre }
